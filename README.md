...
如果你不想看全篇，可以直接阅读这两个最核心的机制拆解：

- [【核心大脑】代理循环与四层记忆压缩机制深度解析](./docs/core_brain_memory_compression.md)
  - 大模型是如何做到连续 Debug 两小时却不“失忆”的？揭秘防线：预算截流、心理活动剪枝、微观打扫战场、启动子模型写回忆录。
- [【操纵 AI 的黑魔法】Prompt 工程的艺术与工具伪装](./docs/prompt_engineering_and_schema.md)
  - 工业级的 Prompt 是怎么写的？剖析动态组装的继承树、伴生宠物的防废话 PUA 法则、隐藏的安全后门，以及让模型自己“翻抽屉”找工具的动态发现机制。
